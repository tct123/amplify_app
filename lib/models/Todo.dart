...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, content, createdAt, updatedAt})
      : _content = content,
  ...
  bool operator ==(Object other) {
    ...
    return other is Todo && id == other.id && _content == other._content;
  }
  ...
  Todo copyWith({String? content}) {
    return Todo._internal(id: id, content: content ?? this.content);
  }

  Todo copyWithModelFieldValues({ModelFieldValue<String?>? content}) {
    return Todo._internal(
